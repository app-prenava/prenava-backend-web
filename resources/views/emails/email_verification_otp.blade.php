...
<html>
<head>
    <title>Verifikasi Email Prenava</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f7f9fc; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <h2 style="color: #424242;">Halo {{ $userName }},</h2>
        <p style="color: #666666; line-height: 1.5;">
            Terima kasih telah mendaftar di Prenava! Silakan masukkan kode OTP berikut untuk memverifikasi email Anda:
        </p>
        ...
        <p style="color: #666666; line-height: 1.5; font-size: 14px;">
            Kode ini berlaku selama <strong>15 menit</strong>. Jika Anda tidak merasa mendaftar di Prenava, abaikan saja email ini.
        </p>
